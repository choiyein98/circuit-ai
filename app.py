...
# ==========================================
# [설정] BrainBoard V51: Hybrid Final
# ==========================================
st.set_page_config(page_title="BrainBoard V51", layout="wide")

MODEL_REAL_PATH = 'best.pt'     # 실물 모델 (V35 기준)
...
def solve_overlap_schematic_v48(parts, distance_threshold=80):
    ...
    for current in parts:
        ...
        for kept in final_parts:
            ...
            # [V48 로직] IoU 0.1 이상이거나 거리 80 미만이면 중복 (공격적 통합)
...
def analyze_real(img, model):
    ...
    # [V35 중복 제거 사용]
    clean_bodies = solve_overlap_real_v35(bodies, dist_thresh=60, iou_thresh=0.4)
...
# [Main UI]
# ==========================================
st.title("🧠 BrainBoard V51: Hybrid Final")
st.markdown("### 회로도(V48 로직) + 실물(V35 로직) 통합 완성본")
